...
public class DatabaseManager
{
	...
	private Connection openConnection() throws DatabaseException
	{
			...
			return openConnectionTo("jdbc:mysql://localhost:3306/pokeproject");
	...
	private Connection openConnectionTo(String url) throws DatabaseException
	{
		try
		{
		...
		try
		{
			return DriverManager.getConnection(url, "root", "KO3113");
